    ...
    <>
      ...
      >
        <ButtonWrapper className="">
          <div
            className={`border-rrGrayBorder relative inset-0 flex h-16 w-16 cursor-pointer items-center justify-center rounded-full border transition-colors duration-1000 ease-rrEaseBurger lg:h-24 lg:w-24 ${isActive ? "bg-primary" : "bg-rrDark dark:bg-rrGray"}`}
          >
            <div
