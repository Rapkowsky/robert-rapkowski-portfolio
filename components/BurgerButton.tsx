...
const BurgerButton = forwardRef<HTMLDivElement, BurgerButtonProps>(function (
  ...
  const burgerContent = (
    <div
      className={`relative inset-0 flex h-16 w-16 cursor-pointer items-center justify-center rounded-full transition-colors duration-1000 ease-rrEaseBurger lg:h-24 lg:w-24 ${isActive ? "bg-primary" : "bg-rrDark dark:bg-rrGray"}`}
    >
      <div
